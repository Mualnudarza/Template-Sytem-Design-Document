...
2. [Layer Responsibility](#2-layer-responsibility)
3. [Naming Convention](#3-naming-convention)
4. [Database Naming Convention](#4-database-naming-convention)
5. [API Naming Convention](#5-api-naming-convention)
6. [Validation Placement](#6-validation-placement)
7. [Business Logic Placement](#7-business-logic-placement)
8. [Repository Usage](#8-repository-usage)
9. [Error Handling Standard](#9-error-handling-standard)
10. [Logging Standard](#10-logging-standard)
11. [Configuration Standard](#11-configuration-standard)
12. [Environment Variable Standard](#12-environment-variable-standard)
13. [Reusable Code Standard](#13-reusable-code-standard)
14. [Documentation in Code Convention](#14-documentation-in-code-convention)
15. [Dependency Management Convention](#15-dependency-management-convention)
16. [Git Workflow](#16-git-workflow)
17. [Branching Convention](#17-branching-convention)
18. [Commit Message Convention](#18-commit-message-convention)
19. [Pull Request Convention](#19-pull-request-convention)
20. [Forbidden Practice](#20-forbidden-practice)
